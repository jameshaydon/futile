...
;"object"==typeof exports&&"undefined"!=typeof module&&(module.exports=hljs);/*! `elm` grammar compiled for Highlight.js 11.8.0 */
...
;hljs.registerLanguage("elm",e)})();/*! `haskell` grammar compiled for Highlight.js 11.8.0 */
(()=>{var e=(()=>{"use strict";return e=>{const n={
...
begin:"->|<-"}]}}})();hljs.registerLanguage("haskell",e)})();/*! `javascript` grammar compiled for Highlight.js 11.8.0 */
(()=>{var e=(()=>{"use strict"
...
;hljs.registerLanguage("javascript",e)})();/*! `python` grammar compiled for Highlight.js 11.8.0 */
...
;hljs.registerLanguage("python",e)})();/*! `scheme` grammar compiled for Highlight.js 11.8.0 */
(()=>{var e=(()=>{"use strict";return e=>{
const t="[^\\(\\)\\[\\]\\{\\}\",'`;#|\\\\\\s]+",n="(-|\\+)?\\d+([./]\\d+)?",r={
$pattern:t,
...
hljs.registerLanguage("futile",() => ({
  name: "Futile",
  keywords: {
    keyword: 'def with lim colim cone cocone hylo if then else case as',
    litteral: 'distr'
  },
  contains: [
    {
