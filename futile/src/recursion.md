...
We consider a category generated by some minimal set of objects we need to make
things typecheck. And then we consider an endofunctor of this category which
encodes the equation above. The idea is to then define `f` as some sort of fixed
point interpretation of this category into your target category.
